...
type Slice_NgingCollectorRule = factory.Slicex[*NgingCollectorRule]
...
func (a *NgingCollectorRule) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingCollectorRule) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingCollectorRule:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCollectorRule(*v))
		case []*NgingCollectorRule:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCollectorRule(v))
		case factory.Ranger:
...
func (a *NgingCollectorRule) Clone() *NgingCollectorRule {
	cloned := NgingCollectorRule{Id: a.Id, PageId: a.PageId, Name: a.Name, Rule: a.Rule, Type: a.Type, Filter: a.Filter, Created: a.Created, Sort: a.Sort}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingCollectorRule) GetField(field string) interface{} {
	switch field {
	case "Id":
		return a.Id
	case "PageId":
...
func (a *NgingCollectorRule) GetAllFieldNames() []string {
	return []string{
		"Id",
		"PageId",
		"Name",
...
func (a *NgingCollectorRule) HasField(field string) bool {
	switch field {
	case "Id":
		return true
	case "PageId":
...
func (a *NgingCollectorRule) ListPageByOffset(cond *db.Compounds, sorts ...interface{}) error {
	return pagination.ListPageByOffset(a, cond, sorts...)
}

func (a *NgingCollectorRule) ListPageByOffsetAs(recv interface{}, cond *db.Compounds, sorts ...interface{}) error {
...
func (a *NgingCollectorRule) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingCollectorRule) TrimOverflowText(column string, value string) string {
