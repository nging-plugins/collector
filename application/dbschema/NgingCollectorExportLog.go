...
type Slice_NgingCollectorExportLog = factory.Slicex[*NgingCollectorExportLog]
...
func (a *NgingCollectorExportLog) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingCollectorExportLog) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingCollectorExportLog:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCollectorExportLog(*v))
		case []*NgingCollectorExportLog:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCollectorExportLog(v))
		case factory.Ranger:
...
func (a *NgingCollectorExportLog) Clone() *NgingCollectorExportLog {
	cloned := NgingCollectorExportLog{Id: a.Id, PageId: a.PageId, ExportId: a.ExportId, Result: a.Result, Status: a.Status, Created: a.Created}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingCollectorExportLog) GetField(field string) interface{} {
	switch field {
	case "Id":
		return a.Id
	case "PageId":
...
func (a *NgingCollectorExportLog) GetAllFieldNames() []string {
	return []string{
		"Id",
		"PageId",
		"ExportId",
...
func (a *NgingCollectorExportLog) HasField(field string) bool {
	switch field {
	case "Id":
		return true
	case "PageId":
...
func (a *NgingCollectorExportLog) ListPageByOffset(cond *db.Compounds, sorts ...interface{}) error {
	return pagination.ListPageByOffset(a, cond, sorts...)
}

func (a *NgingCollectorExportLog) ListPageByOffsetAs(recv interface{}, cond *db.Compounds, sorts ...interface{}) error {
...
func (a *NgingCollectorExportLog) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingCollectorExportLog) TrimOverflowText(column string, value string) string {
